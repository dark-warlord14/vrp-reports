# Security: chrome_70ee0000!v8::internal::ScavengingVisitor<1,1>::EvacuateShortcutCandidate crash

| Field | Value |
|-------|-------|
| **Issue ID** | [40077536](https://issues.chromium.org/issues/40077536) |
| **Status** | Assigned |
| **Severity** | S3-Low |
| **Priority** | P2 |
...
- [screen.wmv](attachments/screen.wmv) (video/x-ms-asf; charset=binary, 837.0 KB)
- [screen.wmv](attachments/screen_53219237.wmv) (video/x-ms-asf; charset=binary, 339.1 KB)
- [screen.wmv](attachments/screen_53219265.wmv) (video/x-ms-asf; charset=binary, 433.8 KB)

## Timeline

### ku...@gmail.com (2013-05-11)

[Empty comment from Monorail migration]

### in...@chromium.org (2013-05-13)

Is this a dup of http://code.google.com/p/chromium/issues/detail?id=240056 ??

### pa...@google.com (2013-05-13)
...
I don't think we should have M-28 and Sec-Impact None. Did we verify that it does not impact m27 ?

### ms...@chromium.org (2013-05-21)

Is there any way to reproduce this issue. I cannot find any information on that. Also I cannot look at the video in https://crbug.com/chromium/240032#c1 because of codec issues. Does the video contain additional information on how to reproduce?

### ku...@gmail.com (2013-05-21)

1, Open 4 https://skydrive.live.com/redir?resid=F69463AC9C52E2E2!107&authkey=!AOGQ5BqTR3ve3Ac
2, Click "edit"


### ku...@gmail.com (2013-05-21)

Google Chrome	28.0.1500.11 (Official Build 199640) dev-m
OS	Windows 
Blink	537.36 (@149738)
...
Google Chrome	29.0.1512.0 (Official Build 200960) canary
OS	Windows 
Blink	537.36 (@150602)
JavaScript	V8 3.19.2



### [Deleted User] (2013-05-22)

Using the provided steps I can not reproduce a crash on Canary, Stable, or Trunk. I'm inclined to close this unless we can get a minimized repro.

### ku...@gmail.com (2013-05-23)

1, Open https://skydrive.live.com/redir?resid=F69463AC9C52E2E2!107&authkey=!AOGQ5BqTR3ve3Ac
...
----------------------
var link;
var ele = document.getElementById('sdx_ow_iframe');
if (ele)
	link = ele.src
if (!link)
	link = frames[0].document.getElementById('sdx_ow_iframe').src

document.body.innerHTML = '<h1><a target="_blank" href='+ link +'>click me</a></h1>'
...
setInterval(function(){
	...
	s.push(w)
	w.onload = function(){
		w.location = w.Common.$0.$C0.application.$Id
	}
	//you may adjust close time
	var close_time = 10;
	close_time *= 1000
	setTimeout(function(){s[id].close()}, close_time)
} , 3000)
...
(e54.ac0): Access violation - code c0000005 (first chance)
First chance exceptions are reported before any exception handling.
This exception may be expected and handled.
eax=00000090 ebx=36600000 ecx=26708111 edx=00000000 esi=013fd570 edi=366f833c
eip=00000000 esp=0042f230 ebp=0042f24c iopl=0         nv up ei pl nz na pe nc
cs=0023  ss=002b  ds=002b  es=002b  fs=0053  gs=002b             efl=00010206
00000000 ??              ???
5:062> .exr -1
ExceptionAddress: 742ac9f1
   ExceptionCode: c0000005 (Access violation)
  ExceptionFlags: 00000000
NumberParameters: 2
...
ChildEBP RetAddr  
WARNING: Frame IP not in any known module. Following frames may be wrong.
0042f22c 6e84391a 0x0
0042f24c 6e843259 chrome_6e080000!v8::internal::MarkCompactCollector::EmptyMarkingDeque(void)+0xe9 [c:\b\build\slave\win\build\src\v8\src\mark-compact.cc @ 1981]
0042f268 6e842f5c chrome_6e080000!v8::internal::RootMarkingVisitor::MarkObjectByPointer(class v8::internal::Object ** p = 0x00000090)+0x134 [c:\b\build\slave\win\build\src\v8\src\mark-compact.cc @ 1725]
0042f274 6e150f94 chrome_6e080000!v8::internal::RootMarkingVisitor::VisitPointer(class v8::internal::Object ** p = 0x061a8400)+0xc [c:\b\build\slave\win\build\src\v8\src\mark-compact.cc @ 1699]
0042f294 6e14f848 chrome_6e080000!v8::internal::GlobalHandles::IterateStrongRoots(class v8::internal::ObjectVisitor * v = 0x0042f2f8)+0x33 [c:\b\build\slave\win\build\src\v8\src\global-handles.cc @ 702]
0042f2ac 6e843e24 chrome_6e080000!v8::internal::Heap::IterateStrongRoots(class v8::internal::ObjectVisitor * v = 0x00000000, v8::internal::VisitMode mode = VISIT_ONLY_STRONG (3))+0x1ec [c:\b\build\slave\win\build\src\v8\src\heap.cc @ 6374]
0042f31c 6e83f834 chrome_6e080000!v8::internal::MarkCompactCollector::MarkLiveObjects(void)+0x35f [c:\b\build\slave\win\build\src\v8\src\mark-compact.cc @ 2130]
0042f330 6e7d3b5f chrome_6e080000!v8::internal::MarkCompactCollector::CollectGarbage(void)+0xb [c:\b\build\slave\win\build\src\v8\src\mark-compact.cc @ 400]
0042f344 6e7d3711 chrome_6e080000!v8::internal::Heap::MarkCompact(class v8::internal::GCTracer * tracer = 0x0042f3b8)+0x59 [c:\b\build\slave\win\build\src\v8\src\heap.cc @ 1069]
0042f384 6e7d32ba chrome_6e080000!v8::internal::Heap::PerformGarbageCollection(v8::internal::GarbageCollector collector = MARK_COMPACTOR (1), class v8::internal::GCTracer * tracer = 0x0042f3b8)+0x1ac [c:\b\build\slave\win\build\src\v8\src\heap.cc @ 914]
0042f498 6e7d3052 chrome_6e080000!v8::internal::Heap::CollectGarbage(v8::internal::AllocationSpace space = OLD_POINTER_SPACE (1), v8::internal::GarbageCollector collector = MARK_COMPACTOR (1), char * gc_reason = 0x705760bc "idle notification: contexts disposed", char * collector_reason = 0x705758cc "GC in old space requested")+0x118 [c:\b\build\slave\win\build\src\v8\src\heap.cc @ 662]
0042f4bc 6e7d7c33 chrome_6e080000!v8::internal::Heap::CollectAllGarbage(int flags = 144, char * gc_reason = 0x705760bc "idle notification: contexts disposed")+0x52 [c:\b\build\slave\win\build\src\v8\src\heap.cc @ 573]
0042f4d8 6e7e2f3b chrome_6e080000!v8::internal::Heap::IdleNotification(int hint = 1000)+0xbc [c:\b\build\slave\win\build\src\v8\src\heap.cc @ 5741]
0042f4e8 6ef1951f chrome_6e080000!v8::internal::V8::IdleNotification(int hint = 0)+0x2a [c:\b\build\slave\win\build\src\v8\src\v8.cc @ 195]
0042f4f0 6e26f5f4 chrome_6e080000!WebCore::V8GCForContextDispose::pseudoIdleTimerFired(class WebCore::Timer<WebCore::V8GCForContextDispose> * __formal = 0x02867140)+0x49 [c:\b\build\slave\win\build\src\third_party\webkit\source\bindings\v8\v8gcforcontextdispose.cpp @ 75]
0042f4f8 6e26ef52 chrome_6e080000!WebCore::Timer<WebCore::EventSender<WebCore::HTMLStyleElement> >::fired(void)+0xb [c:\b\build\slave\win\build\src\third_party\webkit\source\core\platform\timer.h @ 115]
0042f56c 6e26ee25 chrome_6e080000!WebCore::ThreadTimers::sharedTimerFiredInternal(void)+0x117 [c:\b\build\slave\win\build\src\third_party\webkit\source\core\platform\threadtimers.cpp @ 132]
0042f574 6e0e3d07 chrome_6e080000!WebCore::ThreadTimers::sharedTimerFired(void)+0xe [c:\b\build\slave\win\build\src\third_party\webkit\source\core\platform\threadtimers.cpp @ 106]
0042f594 6e0e3c70 chrome_6e080000!base::Timer::RunScheduledTask(void)+0x95 [c:\b\build\slave\win\build\src\base\timer.cc @ 181]
0042f59c 6e0b92be chrome_6e080000!base::BaseTimerTaskInternal::Run(void)+0x1b [c:\b\build\slave\win\build\src\base\timer.cc @ 47]

### ms...@chromium.org (2013-05-23)

Hmm, AFAICT the snippet above is just repeatedly opening some frame from the Word web app in a pop-up, doing a navigation and closing it again. I have tried that several times and couldn't repro. Am I missing something? So far I am unable to reproduce this crasher.

### ms...@chromium.org (2013-05-23)

Yeha, finally got it to go Aww Snap on me with V8 bleeding edge on x64 in release mode. Will try debug mode next.
...
The fix just landed in V8 bleeding edge. The crash from https://crbug.com/chromium/240032#c11 was caused by a pointer into new-space being embedded into optimized code. The leads to missing this pointer from the root-set during a minor GC. Subsequent GCs then inspect this stale pointer. Otherwise the pointer is used for pointer comparison only.

I am not completely sure if this is the same crasher as posted in https://crbug.com/chromium/240032#c1 as the stack-traces look different. But it fixes the crasher that I was able to repro by roughly following steps provided in https://crbug.com/chromium/240032#c10.

https://code.google.com/p/v8/source/detail?r=14777

### in...@chromium.org (2013-05-23)

Was this a recent regression ?

### ms...@chromium.org (2013-05-24)

This was a regression introduced in V8 3.18.1 and hence will require merging back to M28. The M27 branch is not affected. I will merge back once we have Canary coverage of the fix.

### ms...@chromium.org (2013-05-24)

(/me just being unfamiliar with the flags)
...
Merged back to M28 as V8 version 3.18.5.8 just now.

https://code.google.com/p/v8/source/detail?r=14837

### sc...@gmail.com (2013-07-03)

@kuzzcc: thanks! $500 Chromium Security Reward.
...
This issue was migrated from crbug.com/chromium/240032?no_tracker_redirect=1

[Auto-CCs applied]
[Monorail components added to Component Tags custom field.]

---
*Data from [Chromium Issue Tracker](https://issues.chromium.org/issues/40077536)*
