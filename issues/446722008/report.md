...
- exploit.patch (text/x-diff, 4.4 KB)
- renderer.patch (text/x-diff, 796 B)
- index.html (text/html, 451 B)
- main.js (text/javascript, 10.1 KB)
- video.mp4 (video/mp4, 34.9 MB)
- uaf-database-runtasks.textproto (application/octet-stream, 1.1 KB)
...
- deleted (application/octet-stream, 0 B)
- renderer.patch (text/x-diff, 796 B)
- v8.patch (text/x-diff, 6.3 KB)
- exploit.zip (application/zip, 14.5 KB)
- copy_mojo_js_bindings.py (text/x-python, 697 B)
- disable_aslr.py (text/x-python, 1.2 KB)
- rce_64bit_NoASLR.mp4 (video/mp4, 2.6 MB)
- rce_32bit.mp4 (video/mp4, 10.4 MB)
- renderer.patch (text/x-diff, 1.6 KB)
- main32.js (text/javascript, 21.7 KB)
- pe.js (text/javascript, 12.0 KB)
- rce_32bit_reliable.mp4 (video/mp4, 17.5 MB)
