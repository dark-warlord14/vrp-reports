...
- extension.zip (application/zip, 1.2 KB)
- popup.js (text/javascript, 859 B)
- background.js (text/javascript, 38 B)
- manifest.json (application/json, 281 B)
- popup.html (text/html, 188 B)
