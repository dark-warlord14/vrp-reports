...
- PoC1.zip (application/zip, 3.5 KB)
- PoC2.zip (application/zip, 9.1 KB)
- background.js (text/javascript, 466 B)
- devtools.js (text/javascript, 2.6 KB)
- devtools-page.html (text/html, 159 B)
- devtools-page.js (text/javascript, 2.9 KB)
- manifest.json (application/json, 262 B)
- background.js (text/javascript, 988 B)
- devtools.js (text/javascript, 1.8 KB)
- devtools-page.html (text/html, 159 B)
- devtools-page.js (text/javascript, 4.3 KB)
- manifest.json (application/json, 498 B)
- offscreen.html (text/html, 176 B)
- offscreen.js (text/javascript, 2.4 KB)
- pdf-script.js (text/javascript, 2.7 KB)
- perfetto-script.js (text/javascript, 2.2 KB)
- webstore-script.js (text/javascript, 2.8 KB)
