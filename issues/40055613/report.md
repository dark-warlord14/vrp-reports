...
- 1. DownloadsHandler UAF.patch (text/plain, 1.9 KB)
- 2. ImportDataHandler UAF.patch (text/plain, 2.2 KB)
- 3. SearchTabHelper UAF.patch (text/plain, 1.7 KB)
- 4. NewTabPageHandler.patch (text/plain, 1.8 KB)
- 5. PolicyUIHandler UAF.patch (text/plain, 1.7 KB)
