...
There is a raw\_ptr `render_frame_`[1] in the class `AXTreeDistiller`, which could be deleted before the `ScreenAIServiceReady`, causing UAF.
...
[1] <https://source.chromium.org/chromium/chromium/src/+/main:chrome/renderer/accessibility/ax_tree_distiller.cc;l=224;drc=ffd37a22a4ccc86280ccdc82e6abc78338060120;bpv=1;bpt=0>

2. Bisect  
   
   The use of `render_frame_` is introduced in this commit: <https://chromium-review.googlesource.com/c/chromium/src/+/3620253> , and it is used in the constructor of `AXTreeDistiller`. This is introduced in Chrome stable 103.0.5060.53

The `render_frame_` is moved to a stand alone function `ScreenAIServiceReady` in this commit: <https://chromium-review.googlesource.com/c/chromium/src/+/4262827>, and it in introduced in Chrome stable 112.0.5615.49

3. Suggested Patch  
   
   Maybe you could use a weak\_ptr to ensure the lifetime of `render_frame_`.

**Additional Comments:**

\*\*Chrome version: \*\* 110.0.0.0 \*\*Channel: \*\* Not sure
...
### hc...@google.com (2024-01-11)

Abagail, could you take a look?

I am unable to repo this, but poking briefly at the code this could be a problem? I'm not 100% familiar with the code though so I might be mistaken.
...
Setting FoundIn-120 based on use of Stable channel Chrome in video and that the video shows a pretty clear reproduction; the bisects provided also seem reasonable 
Medium severity seems sufficient given mitigations of BRP protection, precondition of a compromised renderer, and non-standard user interaction to trigger this UAF  
...
### ra...@google.com (2024-01-11)

[Empty comment from Monorail migration]

### ra...@google.com (2024-01-12)
...
### jo...@google.com (2024-01-12)

[Empty comment from Monorail migration]

### ha...@google.com (2024-01-13)
...
The following revision refers to this bug:
  https://chromium.googlesource.com/chromium/src/+/2696ed29caedaa156153fceae404c4c4d983ef51

commit 2696ed29caedaa156153fceae404c4c4d983ef51
Author: Jocelyn Tran <jocelyntran@google.com>
Date: Wed Jan 17 16:47:14 2024

[Read Anything] Remove RenderFrame pointer from AXTreeDistiller
...
Cr-Commit-Position: refs/heads/main@{#1248178}

[modify] https://crrev.com/2696ed29caedaa156153fceae404c4c4d983ef51/chrome/renderer/accessibility/read_anything_app_controller_browsertest.cc
[modify] https://crrev.com/2696ed29caedaa156153fceae404c4c4d983ef51/chrome/renderer/accessibility/ax_tree_distiller.h
[modify] https://crrev.com/2696ed29caedaa156153fceae404c4c4d983ef51/chrome/renderer/accessibility/ax_tree_distiller_browsertest.cc
[modify] https://crrev.com/2696ed29caedaa156153fceae404c4c4d983ef51/chrome/renderer/accessibility/ax_tree_distiller.cc
[modify] https://crrev.com/2696ed29caedaa156153fceae404c4c4d983ef51/chrome/renderer/accessibility/read_anything_app_controller.cc


### me...@gmail.com (2024-01-30)

can we mark this as fixed?

### jo...@google.com (2024-01-30)
...
This issue was migrated from crbug.com/chromium/1517513?no_tracker_redirect=1
...
Congratulations Krace! The Chrome VRP Panel has decided to award you $1,000 for this report of a highly mitigated security bug in a non-sandboxed process, mitigated by BRP protection and user gesture, + $1,000 bisect bonus. Thank you for your efforts and reporting this issue to us!
...
### rz...@google.com (2024-03-08)

1. Just <https://crrev.com/c/5343092>
2. Low, no conflicts
3. 122
4. Yes
...
commit 6b7d10d8f870cc7bec070ef3c7b94af9c31fa73d
Author: Jocelyn Tran <jocelyntran@google.com>
Date:   Thu Mar 14 17:22:24 2024
...
https://chromium-review.googlesource.com/5343092
...
marking verrified per commennt 28.
