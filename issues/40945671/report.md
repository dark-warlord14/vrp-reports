# Security: SincResampler buffer UAF

| Field | Value |
|-------|-------|
| **Issue ID** | [40945671](https://issues.chromium.org/issues/40945671) |
| **Status** | Assigned |
| **Severity** | S4-Minimal |
| **Priority** | P1 |
...
void RealtimeAudioDestinationHandler::Render(  
  ...
  if (IsPullingAudioGraphAllowed()) {  
    ...
    scoped_refptr<AudioBus> rendered_bus =  
        Input(0).Pull(destination_bus, number_of_frames);                          <- [1]  
  ...
  context->GetDeferredTaskHandler().ProcessAutomaticPullNodes(number_of_frames);   <- [2]  
...
[1] When the audio rendering thread starts working, the `destination_bus` in the `RealtimeAudioDestinationHandler::Render` function is, in certain cases, used as the `in_place_bus` to pass data between audio nodes.

[2] For automatic nodes, even if a `disconnect` is called to disconnect from the destination node, it may still read from or write to the `destination_bus`.

If an automatic node was previously connected to a destination node, its `AudioNodeOutput` member will hold a pointer to the `destination_bus`. Disconnecting the automatic node from the destination node and calling `RealtimeAudioDestinationHandler::CreatePlatformDestination` to recreate the platform destination will release the `channel data` buffer associated with `destination_bus`. This can lead to a UAF at the next audio rendering.

BISECT

NOTE: This bug was introduced in the early versions of WebKit.  

<https://github.com/WebKit/WebKit/commit/51201a8829cd218305c2b4074ba55c37fcbfd4ea>
...
see uaf\_read.html, uaf\_write.html
...
```
=================================================================  
==27388==ERROR: AddressSanitizer: heap-use-after-free on address 0x11d7ae988da0 at pc 0x7ff6ff9be61c bp 0x0010ecffd710 sp 0x0010ecffd758  
WRITE of size 512 at 0x11d7ae988da0 thread T15  
==27388==WARNING: Failed to use and restart external symbolizer!  
==27388==\*\*\* WARNING: Failed to initialize DbgHelp!              \*\*\*  
==27388==\*\*\* Most likely this means that the app is already      \*\*\*  
==27388==\*\*\* using DbgHelp, possibly with incompatible flags.    \*\*\*  
==27388==\*\*\* Due to technical reasons, symbolization might crash \*\*\*  
==27388==\*\*\* or produce wrong results.                           \*\*\*  
    #0 0x7ff6ff9be61b in __asan_memcpy C:\b\s\w\ir\cache\builder\src\third_party\llvm\compiler-rt\lib\asan\asan_interceptors_memintrinsics.cpp:63  
    #1 0x7ffae956ca4d in blink::AudioWorkletProcessor::CopyArrayBuffersToPort C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\modules\webaudio\audio_worklet_processor.cc:389  
    #2 0x7ffae95685b1 in blink::AudioWorkletProcessor::Process C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\modules\webaudio\audio_worklet_processor.cc:162  
    #3 0x7ffae83a09b7 in blink::AudioWorkletHandler::Process C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\modules\webaudio\audio_worklet_handler.cc:147  
    #4 0x7ffae5eac395 in blink::AudioHandler::ProcessIfNecessary C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\modules\webaudio\audio_handler.cc:347  
    #5 0x7ffae5ea1501 in blink::DeferredTaskHandler::ProcessAutomaticPullNodes C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\modules\webaudio\deferred_task_handler.cc:188  
    #6 0x7ffae603ce6f in blink::RealtimeAudioDestinationHandler::Render C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\modules\webaudio\realtime_audio_destination_handler.cc:240  
    #7 0x7ffae83031dc in blink::AudioDestination::ProvideResamplerInput C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\platform\audio\audio_destination.cc:546  
    #8 0x7ffae8303e36 in base::internal::Invoker<base::internal::BindState<void (blink::AudioDestination::\*)(int, blink::AudioBus \*),WTF::CrossThreadUnretainedWrapper<blink::AudioDestination> >,void (int, blink::AudioBus \*)>::Run C:\b\s\w\ir\cache\builder\src\base\functional\bind_internal.h:932  
    #9 0x7ffae94f6e70 in base::RepeatingCallback<void (int, blink::AudioBus \*)>::Run C:\b\s\w\ir\cache\builder\src\base\functional\callback.h:337  
    #10 0x7ffae94f631c in blink::MediaMultiChannelResampler::ProvideResamplerInput C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\platform\audio\media_multi_channel_resampler.cc:59  
    #11 0x7ffae94f6c0a in base::internal::Invoker<base::internal::BindState<void (blink::MediaMultiChannelResampler::\*)(int, media::AudioBus \*),base::internal::UnretainedWrapper<blink::MediaMultiChannelResampler,base::unretained_traits::MayNotDangle,0> >,void (int, media::AudioBus \*)>::Run C:\b\s\w\ir\cache\builder\src\base\functional\bind_internal.h:932  
    #12 0x7ffac6dba950 in base::RepeatingCallback<void (int, media::AudioBus \*)>::Run C:\b\s\w\ir\cache\builder\src\base\functional\callback.h:337  
    #13 0x7ffac6e155ae in base::internal::Invoker<base::internal::BindState<void (media::MultiChannelResampler::\*)(int, int, float \*),base::internal::UnretainedWrapper<media::MultiChannelResampler,base::unretained_traits::MayNotDangle,0>,int>,void (int, float \*)>::Run C:\b\s\w\ir\cache\builder\src\base\functional\bind_internal.h:932  
    #14 0x7ffac6e49e92 in base::RepeatingCallback<void (int, float \*)>::Run C:\b\s\w\ir\cache\builder\src\base\functional\callback.h:337  
    #15 0x7ffac6e49215 in media::SincResampler::Resample C:\b\s\w\ir\cache\builder\src\media\base\sinc_resampler.cc:283  
    #16 0x7ffae82ffee4 in blink::AudioDestination::RequestRender C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\platform\audio\audio_destination.cc:529  
    #17 0x7ffae8303c40 in base::internal::Invoker<base::internal::BindState<void (blink::AudioDestination::\*)(unsigned long long, unsigned long long, double, double),scoped_refptr<blink::AudioDestination>,unsigned int,unsigned long long,double,double>,void ()>::RunOnce C:\b\s\w\ir\cache\builder\src\base\functional\bind_internal.h:919  
    #18 0x7ffad3a7d87d in base::TaskAnnotator::RunTaskImpl C:\b\s\w\ir\cache\builder\src\base\task\common\task_annotator.cc:201  
    #19 0x7ffad73e5270 in base::sequence_manager::internal::ThreadControllerWithMessagePumpImpl::DoWorkImpl C:\b\s\w\ir\cache\builder\src\base\task\sequence_manager\thread_controller_with_message_pump_impl.cc:461  
    #20 0x7ffad73e4032 in base::sequence_manager::internal::ThreadControllerWithMessagePumpImpl::DoWork C:\b\s\w\ir\cache\builder\src\base\task\sequence_manager\thread_controller_with_message_pump_impl.cc:326  
    #21 0x7ffad741fbaf in base::MessagePumpDefault::Run C:\b\s\w\ir\cache\builder\src\base\message_loop\message_pump_default.cc:40  
    #22 0x7ffad73e6ffd in base::sequence_manager::internal::ThreadControllerWithMessagePumpImpl::Run C:\b\s\w\ir\cache\builder\src\base\task\sequence_manager\thread_controller_with_message_pump_impl.cc:626  
    #23 0x7ffad3ae0eac in base::RunLoop::Run C:\b\s\w\ir\cache\builder\src\base\run_loop.cc:134  
    #24 0x7ffad15d3f1e in blink::scheduler::NonMainThreadImpl::SimpleThreadImpl::Run C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\platform\scheduler\worker\non_main_thread_impl.cc:182  
    #25 0x7ffad3995a71 in base::`anonymous namespace'::ThreadFunc C:\b\s\w\ir\cache\builder\src\base\threading\platform_thread_win.cc:140  
    #26 0x7ff6ff9b22b9 in asan_thread_start C:\b\s\w\ir\cache\builder\src\third_party\llvm\compiler-rt\lib\asan\asan_win.cpp:147  
    #27 0x7ffb964e7343 in BaseThreadInitThunk+0x13 (C:\Windows\System32\KERNEL32.DLL+0x180017343)  
    #28 0x7ffb97c026b0 in RtlUserThreadStart+0x20 (C:\Windows\SYSTEM32\ntdll.dll+0x1800526b0)  
  
0x11d7ae988da0 is located 288 bytes inside of 807-byte region [0x11d7ae988c80,0x11d7ae988fa7)  
freed by thread T0 here:  
    #0 0x7ff6ff9bcb8d in free C:\b\s\w\ir\cache\builder\src\third_party\llvm\compiler-rt\lib\asan\asan_malloc_win.cpp:82  
    #1 0x7ffaea2657a9 in _aligned_free C:\b\s\w\ir\cache\builder\src\out\Release_x64\minkernel\crts\ucrt\src\appcrt\heap\align.cpp:543  
    #2 0x7ffac6e4770f in media::SincResampler::~SincResampler C:\b\s\w\ir\cache\builder\src\media\base\sinc_resampler.cc:194  
    #3 0x7ffac6e15370 in std::__Cr::unique_ptr<media::SincResampler,std::__Cr::default_delete<media::SincResampler> >::reset C:\b\s\w\ir\cache\builder\src\third_party\libc++\src\include\__memory\unique_ptr.h:297  
    #4 0x7ffac6e152b0 in std::__Cr::vector<std::__Cr::unique_ptr<media::SincResampler,std::__Cr::default_delete<media::SincResampler> >,std::__Cr::allocator<std::__Cr::unique_ptr<media::SincResampler,std::__Cr::default_delete<media::SincResampler> > > >::__destroy_vector::operator() C:\b\s\w\ir\cache\builder\src\third_party\libc++\src\include\vector:489  
    #5 0x7ffac6e14451 in media::MultiChannelResampler::~MultiChannelResampler C:\b\s\w\ir\cache\builder\src\media\base\multi_channel_resampler.cc:47  
    #6 0x7ffac6e14d29 in media::MultiChannelResampler::~MultiChannelResampler C:\b\s\w\ir\cache\builder\src\media\base\multi_channel_resampler.cc:47  
    #7 0x7ffae830408a in std::__Cr::default_delete<blink::MediaMultiChannelResampler>::operator() C:\b\s\w\ir\cache\builder\src\third_party\libc++\src\include\__memory\unique_ptr.h:68  
    #8 0x7ffae82fca0f in blink::AudioDestination::~AudioDestination C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\platform\audio\audio_destination.cc:97  
    #9 0x7ffae603ee26 in base::RefCountedThreadSafe<blink::AudioDestination,WTF::DefaultThreadSafeRefCountedTraits<blink::AudioDestination> >::Release C:\b\s\w\ir\cache\builder\src\base\memory\ref_counted.h:417  
    #10 0x7ffae603ba08 in blink::RealtimeAudioDestinationHandler::CreatePlatformDestination C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\modules\webaudio\realtime_audio_destination_handler.cc:316  
    #11 0x7ffae603c33e in blink::RealtimeAudioDestinationHandler::SetChannelCount C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\modules\webaudio\realtime_audio_destination_handler.cc:134  
    #12 0x7ffae5eb6dc9 in blink::`anonymous namespace'::v8_audio_node::ChannelCountAttributeSetCallback C:\b\s\w\ir\cache\builder\src\out\Release_x64\gen\third_party\blink\renderer\bindings\modules\v8\v8_audio_node.cc:165  
    #13 0x7ffac93a9f61 in v8::internal::FunctionCallbackArguments::Call C:\b\s\w\ir\cache\builder\src\v8\src\api\api-arguments-inl.h:101  
    #14 0x7ffac93a63dd in v8::internal::Builtins::InvokeApiFunction C:\b\s\w\ir\cache\builder\src\v8\src\builtins\builtins-api.cc:202  
    #15 0x7ffaca453fb0 in v8::internal::Object::SetPropertyWithAccessor C:\b\s\w\ir\cache\builder\src\v8\src\objects\objects.cc:1571  
    #16 0x7ffaca45d4c4 in v8::internal::Object::SetPropertyInternal C:\b\s\w\ir\cache\builder\src\v8\src\objects\objects.cc:2272  
    #17 0x7ffaca45cb22 in v8::internal::Object::SetProperty C:\b\s\w\ir\cache\builder\src\v8\src\objects\objects.cc:2347  
    #18 0x7ffac9d3fab2 in v8::internal::StoreIC::Store C:\b\s\w\ir\cache\builder\src\v8\src\ic\ic.cc:1838  
    #19 0x7ffac9d58daa in v8::internal::Runtime_StoreIC_Miss C:\b\s\w\ir\cache\builder\src\v8\src\ic\ic.cc:2780  
    #20 0x7ffaea125579 in Builtins_CEntry_Return1_ArgvOnStack_NoBuiltinExit+0x39 (C:\Users\sunburst\projects\fuzzframe\gen\browser\asan-win32-release_x64-1221293\chrome.dll+0x1a55d5579)  
    #21 0x7ffaea20a5ae in Builtins_SetNamedPropertyHandler+0x6e (C:\Users\sunburst\projects\fuzzframe\gen\browser\asan-win32-release_x64-1221293\chrome.dll+0x1a56ba5ae)  
    #22 0x7ffaea08a773 in Builtins_InterpreterEntryTrampoline+0xf3 (C:\Users\sunburst\projects\fuzzframe\gen\browser\asan-win32-release_x64-1221293\chrome.dll+0x1a553a773)  
    #23 0x7ffaea08821b in Builtins_JSEntryTrampoline+0x5b (C:\Users\sunburst\projects\fuzzframe\gen\browser\asan-win32-release_x64-1221293\chrome.dll+0x1a553821b)  
    #24 0x7ffaea087e1a in Builtins_JSEntry+0xda (C:\Users\sunburst\projects\fuzzframe\gen\browser\asan-win32-release_x64-1221293\chrome.dll+0x1a5537e1a)  
    #25 0x7ffac986369f in v8::internal::`anonymous namespace'::Invoke C:\b\s\w\ir\cache\builder\src\v8\src\execution\execution.cc:427  
    #26 0x7ffac9862266 in v8::internal::Execution::Call C:\b\s\w\ir\cache\builder\src\v8\src\execution\execution.cc:528  
    #27 0x7ffac92da127 in v8::Function::Call C:\b\s\w\ir\cache\builder\src\v8\src\api\api.cc:5487  
  
previously allocated by thread T0 here:  
    #0 0x7ff6ff9bcc8d in malloc C:\b\s\w\ir\cache\builder\src\third_party\llvm\compiler-rt\lib\asan\asan_malloc_win.cpp:98  
    #1 0x7ffaea2657f8 in _aligned_malloc C:\b\s\w\ir\cache\builder\src\out\Release_x64\minkernel\crts\ucrt\src\appcrt\heap\align.cpp:555  
    #2 0x7ffad3b7db2c in base::AlignedAlloc C:\b\s\w\ir\cache\builder\src\base\memory\aligned_memory.cc:23  
    #3 0x7ffac6e46980 in media::SincResampler::SincResampler C:\b\s\w\ir\cache\builder\src\media\base\sinc_resampler.cc:170  
    #4 0x7ffac6e138e8 in media::MultiChannelResampler::MultiChannelResampler C:\b\s\w\ir\cache\builder\src\media\base\multi_channel_resampler.cc:27  
    #5 0x7ffae94f5e4d in blink::MediaMultiChannelResampler::MediaMultiChannelResampler C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\platform\audio\media_multi_channel_resampler.cc:23  
    #6 0x7ffae82fb873 in blink::AudioDestination::AudioDestination C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\platform\audio\audio_destination.cc:414  
    #7 0x7ffae82fa736 in blink::AudioDestination::Create C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\platform\audio\audio_destination.cc:90  
    #8 0x7ffae603b971 in blink::RealtimeAudioDestinationHandler::CreatePlatformDestination C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\modules\webaudio\realtime_audio_destination_handler.cc:316  
    #9 0x7ffae603b79c in blink::RealtimeAudioDestinationHandler::Initialize C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\modules\webaudio\realtime_audio_destination_handler.cc:75  
    #10 0x7ffae2145b2f in blink::BaseAudioContext::Initialize C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\modules\webaudio\base_audio_context.cc:122  
    #11 0x7ffae21318c3 in blink::AudioContext::AudioContext C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\modules\webaudio\audio_context.cc:296  
    #12 0x7ffae213e64c in cppgc::MakeGarbageCollectedTrait<blink::AudioContext>::Call<blink::LocalDOMWindow &,blink::WebAudioLatencyHint &,std::__Cr::optional<float> &,blink::WebAudioSinkDescriptor &> C:\b\s\w\ir\cache\builder\src\v8\include\cppgc\allocation.h:242  
    #13 0x7ffae2130404 in blink::MakeGarbageCollected<blink::AudioContext,blink::LocalDOMWindow &,blink::WebAudioLatencyHint &,std::__Cr::optional<float> &,blink::WebAudioSinkDescriptor &> C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\platform\heap\garbage_collected.h:37   
    #14 0x7ffae212f4e5 in blink::AudioContext::Create C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\modules\webaudio\audio_context.cc:212  
    #15 0x7ffae6078572 in blink::`anonymous namespace'::v8_audio_context::ConstructorCallback C:\b\s\w\ir\cache\builder\src\out\Release_x64\gen\third_party\blink\renderer\bindings\modules\v8\v8_audio_context.cc:239  
    #16 0x7ffac93a9f61 in v8::internal::FunctionCallbackArguments::Call C:\b\s\w\ir\cache\builder\src\v8\src\api\api-arguments-inl.h:101  
    #17 0x7ffac93a76db in v8::internal::`anonymous namespace'::HandleApiCallHelper<1> C:\b\s\w\ir\cache\builder\src\v8\src\builtins\builtins-api.cc:114  
    #18 0x7ffac93a51c6 in v8::internal::Builtin_Impl_HandleApiConstruct C:\b\s\w\ir\cache\builder\src\v8\src\builtins\builtins-api.cc:145  
    #19 0x7ffac93a4680 in v8::internal::Builtin_HandleApiConstruct C:\b\s\w\ir\cache\builder\src\v8\src\builtins\builtins-api.cc:136  
    #20 0x7ffaea125479 in Builtins_CEntry_Return1_ArgvOnStack_BuiltinExit+0x39 (C:\Users\sunburst\projects\fuzzframe\gen\browser\asan-win32-release_x64-1221293\chrome.dll+0x1a55d5479)  
    #21 0x7ffaea08b3ce in Builtins_InterpreterPushArgsThenFastConstructFunction+0x28e (C:\Users\sunburst\projects\fuzzframe\gen\browser\asan-win32-release_x64-1221293\chrome.dll+0x1a553b3ce)  
    #22 0x7ffaea215712 in Builtins_ConstructHandler+0x352 (C:\Users\sunburst\projects\fuzzframe\gen\browser\asan-win32-release_x64-1221293\chrome.dll+0x1a56c5712)  
    #23 0x7ffaea08a773 in Builtins_InterpreterEntryTrampoline+0xf3 (C:\Users\sunburst\projects\fuzzframe\gen\browser\asan-win32-release_x64-1221293\chrome.dll+0x1a553a773)  
    #24 0x7ffaea08821b in Builtins_JSEntryTrampoline+0x5b (C:\Users\sunburst\projects\fuzzframe\gen\browser\asan-win32-release_x64-1221293\chrome.dll+0x1a553821b)  
    #25 0x7ffaea087e1a in Builtins_JSEntry+0xda (C:\Users\sunburst\projects\fuzzframe\gen\browser\asan-win32-release_x64-1221293\chrome.dll+0x1a5537e1a)  
    #26 0x7ffac986369f in v8::internal::`anonymous namespace'::Invoke C:\b\s\w\ir\cache\builder\src\v8\src\execution\execution.cc:427  
    #27 0x7ffac9866bfb in v8::internal::Execution::CallScript C:\b\s\w\ir\cache\builder\src\v8\src\execution\execution.cc:539  
...
Thread T15 created by T0 here:  
    ...
    #2 0x7ffad3a3e42e in base::SimpleThread::StartAsync C:\b\s\w\ir\cache\builder\src\base\threading\simple_thread.cc:55  
    #3 0x7ffad15d1c38 in blink::NonMainThread::CreateThread C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\platform\scheduler\worker\non_main_thread_impl.cc:40  
    #4 0x7ffadfadfa39 in blink::WorkerBackingThread::WorkerBackingThread C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\core\workers\worker_backing_thread.cc:105  
    #5 0x7ffae83a997a in blink::WorkletThreadHolder<blink::RealtimeAudioWorkletThread>::EnsureInstance C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\core\workers\worklet_thread_holder.h:36  
    #6 0x7ffae83aae65 in blink::RealtimeAudioWorkletThread::RealtimeAudioWorkletThread C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\modules\webaudio\realtime_audio_worklet_thread.cc:58  
    #7 0x7ffae60af042 in blink::AudioWorkletMessagingProxy::CreateWorkletThreadWithConstraints C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\modules\webaudio\audio_worklet_messaging_proxy.cc:123  
    #8 0x7ffae60aefc1 in blink::AudioWorkletMessagingProxy::CreateWorkerThread C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\modules\webaudio\audio_worklet_messaging_proxy.cc:107  
    #9 0x7ffadd459f03 in blink::ThreadedMessagingProxyBase::InitializeWorkerThread C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\core\workers\threaded_messaging_proxy_base.cc:83  
    #10 0x7ffae5d30587 in blink::ThreadedWorkletMessagingProxy::Initialize C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\core\workers\threaded_worklet_messaging_proxy.cc:157  
    #11 0x7ffae608134d in blink::AudioWorklet::CreateGlobalScope C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\modules\webaudio\audio_worklet.cc:82  
    #12 0x7ffae5d0de77 in blink::Worklet::FetchAndInvokeScript C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\core\workers\worklet.cc:169  
    #13 0x7ffae5d1179a in base::internal::Invoker<base::internal::BindState<void (blink::Worklet::\*)(const blink::KURL &, const WTF::String &, blink::WorkletPendingTasks \*),cppgc::internal::BasicPersistent<blink::Worklet,cppgc::internal::StrongPersistentPolicy,cppgc::internal::IgnoreLocationPolicy,cppgc::internal::DisabledCheckingPolicy>,blink::KURL,blink::V8RequestCredentials,cppgc::internal::BasicPersistent<blink::WorkletPendingTasks,cppgc::internal::StrongPersistentPolicy,cppgc::internal::IgnoreLocationPolicy,cppgc::internal::DisabledCheckingPolicy> >,void   
()>::RunOnce C:\b\s\w\ir\cache\builder\src\base\functional\bind_internal.h:919  
    #14 0x7ffad3a7d87d in base::TaskAnnotator::RunTaskImpl C:\b\s\w\ir\cache\builder\src\base\task\common\task_annotator.cc:201  
    #15 0x7ffad73e5270 in base::sequence_manager::internal::ThreadControllerWithMessagePumpImpl::DoWorkImpl C:\b\s\w\ir\cache\builder\src\base\task\sequence_manager\thread_controller_with_message_pump_impl.cc:461  
    #16 0x7ffad73e4032 in base::sequence_manager::internal::ThreadControllerWithMessagePumpImpl::DoWork C:\b\s\w\ir\cache\builder\src\base\task\sequence_manager\thread_controller_with_message_pump_impl.cc:326  
    #17 0x7ffad741fbaf in base::MessagePumpDefault::Run C:\b\s\w\ir\cache\builder\src\base\message_loop\message_pump_default.cc:40  
    #18 0x7ffad73e6ffd in base::sequence_manager::internal::ThreadControllerWithMessagePumpImpl::Run C:\b\s\w\ir\cache\builder\src\base\task\sequence_manager\thread_controller_with_message_pump_impl.cc:626  
    #19 0x7ffad3ae0eac in base::RunLoop::Run C:\b\s\w\ir\cache\builder\src\base\run_loop.cc:134  
    #20 0x7ffad6b300f4 in content::RendererMain C:\b\s\w\ir\cache\builder\src\content\renderer\renderer_main.cc:366  
    #21 0x7ffad203b6bb in content::RunOtherNamedProcessTypeMain C:\b\s\w\ir\cache\builder\src\content\app\content_main_runner_impl.cc:769  
    #22 0x7ffad203e4ad in content::ContentMainRunnerImpl::Run C:\b\s\w\ir\cache\builder\src\content\app\content_main_runner_impl.cc:1138  
    #23 0x7ffad20390df in content::RunContentProcess C:\b\s\w\ir\cache\builder\src\content\app\content_main.cc:334  
    #24 0x7ffad2039d92 in content::ContentMain C:\b\s\w\ir\cache\builder\src\content\app\content_main.cc:347  
    #25 0x7ffac4b51746 in ChromeMain C:\b\s\w\ir\cache\builder\src\chrome\app\chrome_main.cc:190  
    #26 0x7ff6ff905f72 in MainDllLoader::Launch C:\b\s\w\ir\cache\builder\src\chrome\app\main_dll_loader_win.cc:169  
    #27 0x7ff6ff902a5c in main C:\b\s\w\ir\cache\builder\src\chrome\app\chrome_exe_main_win.cc:392  
    #28 0x7ff6ffd3218b in __scrt_common_main_seh D:\a\_work\1\s\src\vctools\crt\vcstartup\src\startup\exe_common.inl:288  
    #29 0x7ffb964e7343 in BaseThreadInitThunk+0x13 (C:\Windows\System32\KERNEL32.DLL+0x180017343)  
    #30 0x7ffb97c026b0 in RtlUserThreadStart+0x20 (C:\Windows\SYSTEM32\ntdll.dll+0x1800526b0)  
  
SUMMARY: AddressSanitizer: heap-use-after-free C:\b\s\w\ir\cache\builder\src\third_party\llvm\compiler-rt\lib\asan\asan_interceptors_memintrinsics.cpp:63 in __asan_memcpy  
Shadow bytes around the buggy address:  
  0x11d7ae988b00: fd fd fd fd fd fd fd fd fd fd fd fd fd fd fd fd  
  0x11d7ae988b80: fd fd fd fd fd fd fd fd fd fd fd fa fa fa fa fa  
  0x11d7ae988c00: fa fa fa fa fa fa fa fa fa fa fa fa fa fa f7 fa  
  0x11d7ae988c80: fd fd fd fd fd fd fd fd fd fd fd fd fd fd fd fd  
  0x11d7ae988d00: fd fd fd fd fd fd fd fd fd fd fd fd fd fd fd fd  
=>0x11d7ae988d80: fd fd fd fd[fd]fd fd fd fd fd fd fd fd fd fd fd  
  0x11d7ae988e00: fd fd fd fd fd fd fd fd fd fd fd fd fd fd fd fd  
  0x11d7ae988e80: fd fd fd fd fd fd fd fd fd fd fd fd fd fd fd fd  
  0x11d7ae988f00: fd fd fd fd fd fd fd fd fd fd fd fd fd fd fd fd  
  0x11d7ae988f80: fd fd fd fd fd fa fa fa fa fa fa fa fa fa fa fa  
  0x11d7ae989000: fa fa fa fa fa fa fa fa fa fa fa fa fa fa f7 fa  
...
==27388==ADDITIONAL INFO  
  
==27388==Note: Please include this section with the ASan report.  
Task trace:  
    #0 0x7ffae82fe0aa in blink::AudioDestination::Render C:\b\s\w\ir\cache\builder\src\third_party\blink\renderer\platform\audio\audio_destination.cc:193  
...
- [uaf_read.html](attachments/uaf_read.html) (text/plain, 975 B)
- [uaf_write.html](attachments/uaf_write.html) (text/plain, 1.0 KB)
...
ClusterFuzz is analyzing your testcase. Developers can follow the progress at https://clusterfuzz.com/testcase?key=6462875942453248.

### su...@gmail.com (2023-11-25)

Sorry, I forgot to remind you. AudioContext doesn't automatically render by default, CF should add the --autoplay-policy=no-user-gesture-required command-line parameter.

### cl...@chromium.org (2023-11-25)

ClusterFuzz is analyzing your testcase. Developers can follow the progress at https://clusterfuzz.com/testcase?key=4572332891242496.
...
Detailed Report: https://clusterfuzz.com/testcase?key=4572332891242496
...
Crash Address: 0x51800000bd80
Crash State:
  blink::AudioWorkletHandler::Process
  blink::AudioHandler::ProcessIfNecessary
  blink::DeferredTaskHandler::ProcessAutomaticPullNodes
  
Sanitizer: address (ASAN)

Recommended Security Severity: High

Regressed: https://clusterfuzz.com/revisions?job=linux_asan_chrome_mp&range=761622:761623

Reproducer Testcase: https://clusterfuzz.com/download?testcase_id=4572332891242496
...
### mj...@chromium.org (2023-11-27)

[Empty comment from Monorail migration]

### mj...@chromium.org (2023-11-28)

[Empty comment from Monorail migration]

### mj...@chromium.org (2023-11-29)

Reproduced both crashes locally.  Continuing to look into this.

### mj...@chromium.org (2023-11-30)

It looks like calling Dispose() instead of StopPlatformDestination() here:

https://source.chromium.org/chromium/chromium/src/+/main:third_party/blink/renderer/modules/webaudio/realtime_audio_destination_handler.cc;l=133;drc=8e78783dc1f7007bad46d657c9f332614e240fd8

prevents the crashes, but I'm not sure if that's the correct fix.  Will consult / investigate.

### mj...@chromium.org (2023-11-30)

Uninitialize() also seems to work, and is less aggressive.

### mj...@chromium.org (2023-11-30)

https://crbug.com/chromium/1505080#c13 https://crbug.com/chromium/1505080#c14 This is wrong, if we initialize again we still get the crash.  Calling these functions just makes the rendering not start again.

### mj...@chromium.org (2023-12-01)

Changing the context_graph_mutex_ in deferred_task_handler to a base::Lock instead, and then adding the auto-locker to the RealtimeAudioDestinationNode::Render() function, seemed to fix this.  I think this will likely cause performance problems, and may cause deadlock problems, but will put a speculative CL up for testing and review.
...
https://crbug.com/chromium/1505080#c16 It looks like this was also wrong; it seems like locking in the render function just prevents the pre-render tasks from running and becoming active.

### mj...@chromium.org (2023-12-02)

I think I've been looking in the wrong spot.  Modifying uaf_read.html to just do one iteration still reproduces the crash.  I don't think this is a race condition.

### mj...@chromium.org (2023-12-02)

I found that we don't retain the pointer in the resampler.  Changing this line:
https://crsrc.org/c/third_party/blink/renderer/platform/audio/audio_destination.cc;l=417
...
will fix the crashes.  I don't know if this has any other memory implications, but will get the CL up for now.

### mj...@chromium.org (2023-12-02)

https://crbug.com/chromium/1505080#c20 doesn't actually work with the reference counter, but it seems like we might be able to fix it with a trylock on the device_state_lock_ in AudioDestination::ProvideResamplerInput instead.

### mj...@chromium.org (2023-12-02)

https://crbug.com/chromium/1505080#c21 That doesn't really work either, since we sometimes miss producing samples.

If there's no quick fix to be found we could solve this by eliminating the resampler altogether (see crbug.com/1503735).

### mj...@chromium.org (2023-12-02)

I am trying to work around the refcounter checks in #21 by initializing the resampler outside the constructor, in the factory method.  But this is now leaking the object, so this doesn't look like the right way to do it either.

WIP is here: crrev.com/c/5080509

### ho...@chromium.org (2023-12-04)

I looked into this problem today, and here's what I see:

1. Removing the sample rate option in the repro code prevents ASAN crash from happening.
2. So the culprit is unique_ptr<> of resampler_ and resampler_bus_ (media::AudioBus) in AudioDestination: Re-creating the destination platform causes these members to go away while the audio thread is still reading/writing to this transitional bus.
3. This is sort of bound to happen because media::AudioBus is not thread-safe. It doesn't have the template of ThreadSafeRefCounted interface. So we can't use it with scoped_refptr. We don't see ASAN crash with the default sample rate because all transitional bus objects are scoped_refptr.
4. The most viable solution would be making MediaMultiChannelResampler class to be thread-safe and use it via scoped_refptr in AudioDestination. (with its transitional bus as a scoped_refptr too)

I believe mixing media::AudioBus (not thread-safe) and blink::AudioBus (thread-safe) is the starting point of this problem. I'll try the step 4 tomorrow and see how it goes.

### mj...@chromium.org (2023-12-05)

We identified a few more things to try:
1) Don't use the resampler_bus_ and call Resample() instead of ResampleInternal() -- I tried this and it didn't fix the problem
2) Use media::MultiChannelResampler directly instead of the wrapper class -- I am trying this but think it will be unlikely to fix the problem
3) Use an array of SincResamplers directly on the AudioDestination and do the resampling directly in RequestRender -- I will try this next after trying (2)

### mj...@chromium.org (2023-12-05)

https://crbug.com/chromium/1505080#c25 (2) also did not fix the problem.  Trying (3) now.

### [Deleted User] (2023-12-06)

[Empty comment from Monorail migration]

### mj...@chromium.org (2023-12-06)

https://crbug.com/chromium/1505080#c25 (3) may fix the problem but the number of samples needs to be handled carefully.  A WIP is here (not fully working yet): crrev.com/c/5097333

### mj...@chromium.org (2023-12-06)

It looks like extending the CL in https://crbug.com/chromium/1505080#c28 to use the streaming method may involve reimplementing much of the logic of the existing multi channel resamplers.  It does fix the crash by keeping things on the same thread though.

I will look one more time at if we can retain the pointer in a safe way.  I think the long-term solution is delegating resampling to the lower layers of the audio stack.

### mj...@chromium.org (2023-12-07)

I also looked at disconnecting the outputs in DeferredTaskHandler::AddAutomaticPullNode but that didn't fix the issue.

Hongchan, can you please take a look?

### ho...@chromium.org (2023-12-08)

Okay. Once I have a confirmation for https://crbug.com/1505086, I'll focus on this issue.

### ho...@chromium.org (2023-12-12)

Just to provide updates:

I have tried different approaches for this issue, and one of them was bailing out just before memcpy() if the pointer is invalid. That was not successful either and it confirms that the pointer is being dropped in the middle of memcpy() operation.

Right now I am experimenting with the idea of keeping the destination for a while until the new destination is fully operational.

### ho...@chromium.org (2023-12-12)

[Empty comment from Monorail migration]

### ho...@chromium.org (2023-12-13)

[Empty comment from Monorail migration]

### ho...@chromium.org (2023-12-16)

So far here's what I found:

1) uaf-write.html

This repro triggers a rare corner case when handling the automatic pull node. When disconnected, AudioNodeOutputs of the AudioWorkletNode are modified on the main thread data (inputs_) correctly but it failed to propagate and synchronize with the rendering input (rendering_fan_out_count_) - this is because recreating the AudioDestination (SetChannelCount) somehow prevents them from being synchronized.

So manual synchronization upon disconnection fixes the issue. There's a WIP CL, but it's failing some of existing tests and needs a bit more work.

2) uaf-read.html

I speculate the general problem would be in the similar area. I can see that the rendering fan out count and the main thread fan out count are different within the Process function of AnalyserHandler. Once we have a robust fix for 1) I am certain we can apply the same approach to this one as well.



### ho...@chromium.org (2023-12-18)

Here's another update:

I am still trying to find the right spot for the manual synchronization, but it has been particularly tricky. Some methods can be called from both sides (main/audio) and even after a careful placement of the manual sync, the patch fails on some tests.


### ho...@chromium.org (2023-12-20)

The CL is ready for review: https://crrev.com/c/5131958

mjwilson@ - Could you take a look? Also feel free to merge if it looks good. Otherwise, I'll continue to work on this after the first week of January.
...
The following revision refers to this bug:
  https://chromium.googlesource.com/chromium/src/+/f4bffa09b46c21147431179e1e6dd2b27bc35fbc

commit f4bffa09b46c21147431179e1e6dd2b27bc35fbc
Author: Hongchan Choi <hongchan@chromium.org>
Date: Fri Jan 12 22:57:22 2024
...
[modify] https://crrev.com/f4bffa09b46c21147431179e1e6dd2b27bc35fbc/third_party/blink/web_tests/external/wpt/webaudio/the-audio-api/the-audioworklet-interface/audioworkletprocessor-process-frozen-array.https.html
[modify] https://crrev.com/f4bffa09b46c21147431179e1e6dd2b27bc35fbc/third_party/blink/renderer/modules/webaudio/audio_worklet_processor.cc
[modify] https://crrev.com/f4bffa09b46c21147431179e1e6dd2b27bc35fbc/third_party/blink/renderer/modules/webaudio/deferred_task_handler.cc
[add] https://crrev.com/f4bffa09b46c21147431179e1e6dd2b27bc35fbc/third_party/blink/web_tests/external/wpt/webaudio/the-audio-api/the-audioworklet-interface/process-parameters.https-expected.txt
[modify] https://crrev.com/f4bffa09b46c21147431179e1e6dd2b27bc35fbc/third_party/blink/renderer/modules/webaudio/analyser_handler.cc
[modify] https://crrev.com/f4bffa09b46c21147431179e1e6dd2b27bc35fbc/third_party/blink/renderer/modules/webaudio/audio_worklet_handler.cc


### cl...@chromium.org (2024-01-13)

ClusterFuzz testcase 4572332891242496 is verified as fixed in https://clusterfuzz.com/revisions?job=linux_asan_chrome_mp&range=1246713:1246723
...
Requesting merge to stable M120 because latest trunk commit (1246718) appears to be after stable branch point (1217362).

Requesting merge to beta M121 because latest trunk commit (1246718) appears to be after beta branch point (1233107).
...
### ho...@chromium.org (2024-01-16)

1. P1 Security bug with "Security_Severity-High"
2. https://crrev.com/c/5131958
3. Yes
4. No
5. N/A
6. No
...
### go...@chromium.org (2024-01-16)

+Security TPMs for merge review.

Please note we're cutting M121 Early Stable RC today. 

### pg...@google.com (2024-01-16)

Merge approved for M121! Please merge today to get this change into M121 early stable, if possible!
Merge approved for M120! Please merge by Thursday Jan 18 EOD MTV time to get this into the next M120 extended stable release!

### gi...@appspot.gserviceaccount.com (2024-01-16)

The following revision refers to this bug:
  https://chromium.googlesource.com/chromium/src/+/f87ed96dc126c850a773331dd30b590dd6687a0f

commit f87ed96dc126c850a773331dd30b590dd6687a0f
Author: Hongchan Choi <hongchan@chromium.org>
Date: Tue Jan 16 22:26:28 2024
...
[modify] https://crrev.com/f87ed96dc126c850a773331dd30b590dd6687a0f/third_party/blink/web_tests/external/wpt/webaudio/the-audio-api/the-audioworklet-interface/audioworkletprocessor-process-frozen-array.https.html
[modify] https://crrev.com/f87ed96dc126c850a773331dd30b590dd6687a0f/third_party/blink/renderer/modules/webaudio/audio_worklet_processor.cc
[modify] https://crrev.com/f87ed96dc126c850a773331dd30b590dd6687a0f/third_party/blink/renderer/modules/webaudio/deferred_task_handler.cc
[add] https://crrev.com/f87ed96dc126c850a773331dd30b590dd6687a0f/third_party/blink/web_tests/external/wpt/webaudio/the-audio-api/the-audioworklet-interface/process-parameters.https-expected.txt
[modify] https://crrev.com/f87ed96dc126c850a773331dd30b590dd6687a0f/third_party/blink/renderer/modules/webaudio/analyser_handler.cc
[modify] https://crrev.com/f87ed96dc126c850a773331dd30b590dd6687a0f/third_party/blink/renderer/modules/webaudio/audio_worklet_handler.cc
...
M120 merge approved, please merge https://crrev.com/c/5131958 to branch 6099 by EOD Friday, so this fix can be included in the M120 Extended Stable release next week. 

### ho...@chromium.org (2024-01-18)

Re https://crbug.com/chromium/1505080#c54:

https://crrev.com/c/5214669
...
Congratulations Huang Xilin! The Chrome VRP Panel has decided to award you $10,000 for this high quality report of renderer process memory corruption + $1,000 bisect bonus. Thank you for your efforts and reporting this issue to us -- nice work! 

### gi...@appspot.gserviceaccount.com (2024-01-19)

The following revision refers to this bug:
  https://chromium.googlesource.com/chromium/src/+/cc07a95bc3099eaf38e0268f2a19f909ea240833

commit cc07a95bc3099eaf38e0268f2a19f909ea240833
Author: Hongchan Choi <hongchan@chromium.org>
Date: Fri Jan 19 19:17:18 2024
...
[modify] https://crrev.com/cc07a95bc3099eaf38e0268f2a19f909ea240833/third_party/blink/web_tests/external/wpt/webaudio/the-audio-api/the-audioworklet-interface/audioworkletprocessor-process-frozen-array.https.html
[modify] https://crrev.com/cc07a95bc3099eaf38e0268f2a19f909ea240833/third_party/blink/renderer/modules/webaudio/audio_worklet_processor.cc
[modify] https://crrev.com/cc07a95bc3099eaf38e0268f2a19f909ea240833/third_party/blink/renderer/modules/webaudio/deferred_task_handler.cc
[add] https://crrev.com/cc07a95bc3099eaf38e0268f2a19f909ea240833/third_party/blink/web_tests/external/wpt/webaudio/the-audio-api/the-audioworklet-interface/process-parameters.https-expected.txt
[modify] https://crrev.com/cc07a95bc3099eaf38e0268f2a19f909ea240833/third_party/blink/renderer/modules/webaudio/analyser_handler.cc
[modify] https://crrev.com/cc07a95bc3099eaf38e0268f2a19f909ea240833/third_party/blink/renderer/modules/webaudio/audio_worklet_handler.cc
...
1. Just https://crrev.com/c/5225523
...
This issue was migrated from crbug.com/chromium/1505080?no_tracker_redirect=1
...
commit c4f7434873f53afd2b4cfcb66a71c20966ced7ae
Author: Hongchan Choi <hongchan@chromium.org>
Date:   Tue Feb 13 13:11:22 2024

    [M114-LTS] Update rendering state of automatic pull nodes before graph rendering
    ...
    Commit-Queue: Hongchan Choi <hongchan@chromium.org>
    Cr-Original-Commit-Position: refs/heads/main@{#1246718}
    Reviewed-on: https://chromium-review.googlesource.com/c/chromium/src/+/5225523
    Commit-Queue: Roger Felipe Zanoni da Silva <rzanoni@google.com>
    Reviewed-by: Michael Wilson <mjwilson@chromium.org>
    Owners-Override: Victor Gabriel Savu <vsavu@google.com>
    Reviewed-by: Victor Gabriel Savu <vsavu@google.com>
    Reviewed-by: Hongchan Choi <hongchan@chromium.org>
    Cr-Commit-Position: refs/branch-heads/5735@{#1693}
    Cr-Branched-From: 2f562e4ddbaf79a3f3cb338b4d1bd4398d49eb67-refs/heads/main@{#1135570}

M       third_party/blink/renderer/modules/webaudio/analyser_handler.cc
M       third_party/blink/renderer/modules/webaudio/analyser_handler.h
...
https://chromium-review.googlesource.com/5225523
...
---
*Data from [Chromium Issue Tracker](https://issues.chromium.org/issues/40945671)*
