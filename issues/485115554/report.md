# Integer Overflow in H265 SEI Parsing

| Field | Value |
|-------|-------|
| **Issue ID** | [485115554](https://issues.chromium.org/issues/485115554) |
| **Status** | Accepted |
| **Severity** | S3-Low |
| **Priority** | P3 |
...
A signed integer overflow occurs in Chromium’s H.265 parser while processing SEI (Supplemental Enhancement Information) data. The overflow happens during multiplication of a large parsed value, which can lead to crash

Vulnerable File Details

```
media/parsers/h265_parser.cc
Function: media::H265Parser::ParseSEI
Line: 2144
...
```
./media_h265_parser_fuzzer sei_overflow.h265

```

Attached a poc file, The file contains a crafted SEI payload with a large parsed field value designed to overflow during size calculation.
...
INFO: Seed: 4166765090
INFO: Loaded 1 modules   (2164628 inline 8-bit counters): 2164628 [0x630b9b2a4ac0, 0x630b9b4b5254), 
INFO: Loaded 1 PC tables (2164628 PCs): 2164628 [0x630b9b4b5258,0x630b9d5bcb98), 
./media_h265_parser_fuzzer: Running 1 inputs 1 time(s) each.
Running: /home/basha/Downloads/win_repro/sei_overflow.h265
../../media/parsers/h265_parser.cc:2144:40: runtime error: signed integer overflow: 268435456 * 8 cannot be represented in type 'int'
    #0 0x630b922e623c in media::H265Parser::ParseSEI(media::H265SEI*) media/parsers/h265_parser.cc:2144:40
    #1 0x630b8e0677b7 in LLVMFuzzerTestOneInput media/parsers/h265_parser_fuzzertest.cc:43:22
    #2 0x630b8e0ab27c in fuzzer::Fuzzer::ExecuteCallback(unsigned char const*, unsigned long) third_party/libFuzzer/src/FuzzerLoop.cpp:619:13
    #3 0x630b8e07c2b1 in fuzzer::RunOneTest(fuzzer::Fuzzer*, char const*, unsigned long) third_party/libFuzzer/src/FuzzerDriver.cpp:328:6
    #4 0x630b8e084da0 in fuzzer::FuzzerDriver(int*, char***, int (*)(unsigned char const*, unsigned long)) third_party/libFuzzer/src/FuzzerDriver.cpp:863:9
    #5 0x630b8e067fdd in main third_party/libFuzzer/src/FuzzerMain.cpp:20:10
    #6 0x7ef19742a1c9 in __libc_start_call_main csu/../sysdeps/nptl/libc_start_call_main.h:58:16
    #7 0x7ef19742a28a in __libc_start_main csu/../csu/libc-start.c:360:3
    #8 0x630b8df8ab29 in _start (/home/basha/Desktop/chromefuzz/chromium/src/out/UBSanMedia/media_h265_parser_fuzzer+0x7c11b29) (BuildId: 851ee95e8c3708a1)

SUMMARY: UndefinedBehaviorSanitizer: undefined-behavior ../../media/parsers/h265_parser.cc:2144:40 
Executed /home/basha/Downloads/win_repro/sei_overflow.h265 in 275 ms
***
...
- [sei_overflow.h265](attachments/sei_overflow.h265) (application/octet-stream, 1.0 MB)

## Timeline

### am...@gmail.com (2026-02-17)

Team, How can i include my collaborator to this report, so that he can also track the status
...
---
*Data from [Chromium Issue Tracker](https://issues.chromium.org/issues/485115554)*
