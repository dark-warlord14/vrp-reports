...
- dragclick-patch.diff (text/x-diff, 16.5 KB)
- touch-drag-click-cr.html (text/html, 18.0 KB)
- dragclick-uxss.mp4 (video/mp4, 1.7 MB)
- dragclick-uxss-open-settings-show-bookmarks-bar.mp4 (video/mp4, 659.8 KB)
- dragclick-pwn-all-the-things.mp4 (video/mp4, 4.3 MB)
- manifest.json (application/json, 402 B)
- background.js (text/javascript, 6.3 KB)
- page.html (text/html, 390 B)
- page.js (text/javascript, 9.2 KB)
- self-closing.html (text/html, 90 B)
- self-closing.js (text/javascript, 15 B)
...
- drag_diffs.txt (text/plain, 1.2 KB)
- mitigations.txt (text/plain, 20.2 KB)
- persistent-touch-state.html (text/html, 620 B)
- basic-click-demo.html (text/html, 2.0 KB)
- click-monitor.html (text/html, 535 B)
- basic-repro.log (text/plain, 7.0 KB)
- deleted (application/octet-stream, 0 B)
- touch_diffs.txt (text/plain, 4.3 KB)
- dragclick-web-contents-bounds-bypass.mp4 (video/mp4, 1.3 MB)
