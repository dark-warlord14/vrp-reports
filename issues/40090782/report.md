# Data URL doesn't inherit CSP

| Field | Value |
|-------|-------|
| **Issue ID** | [40090782](https://issues.chromium.org/issues/40090782) |
| **Status** | Assigned |
| **Severity** | S3-Low |
| **Priority** | P2 |
...
1. Go to https://test.shhnjk.com/docuwri.html

What is the expected behavior?
No alert shown.

What went wrong?
Alert popups from data URL iframe. This should be blocked since data URL should inherit CSP from parent frame.
...
- [poc.html](attachments/poc.html) (text/plain, 217 B)
...
Looks like the server behind htts://test.shhnjk.com is down.

### s....@gmail.com (2018-03-15)

Sorry, sometimes it’s unstable. Could you try it now? I could access now.
...
Attaching PoC just in case.

### da...@chromium.org (2018-03-15)

Thanks! Confirmed that this reproduces in Chrome on iOS, Safari and Firefox. We should file a WebKit bug.
...
### ar...@chromium.org (2020-01-17)

I would like to take a look at this.

### ar...@chromium.org (2020-01-17)

This is working correctly on Chrome for linux.
Sorry, I didn't saw this was an iOS bug only. It depends on Webkit, not blink.

s.h.h.n.j.k@gmail.com => Could you please check this has been fixed by Webkit and update the bug?
...
This issue was migrated from crbug.com/chromium/821625?no_tracker_redirect=1

[Auto-CCs applied]
[Monorail components added to Component Tags custom field.]

---
*Data from [Chromium Issue Tracker](https://issues.chromium.org/issues/40090782)*
